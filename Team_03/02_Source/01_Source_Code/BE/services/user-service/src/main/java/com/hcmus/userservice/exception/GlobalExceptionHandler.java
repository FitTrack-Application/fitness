...
import com.hcmus.userservice.controller.UserController;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleAuthenticationException(ConflictException exception) {
        final ApiResponse<?> response = ApiResponse.builder()
                .status(HttpStatus.CONFLICT.value())
                .generalMessage("Conflict problem, run failed!")
                .errorDetails(List.of(exception.getMessage()))
                .timestamp(LocalDateTime.now())
                .build();
        return ResponseEntity.ok(response);
    ...
    ResponseEntity<ApiResponse<?>> handleUserNotFoundException(UserNotFoundException exception) {
        final ApiResponse<?> response = ApiResponse.builder()
                .status(HttpStatus.BAD_REQUEST.value())
    ...
    ResponseEntity<ApiResponse<?>> handleLoginException(BadCredentialsException exception) {
        final ApiResponse<?> response = ApiResponse.builder()
                .status(HttpStatus.BAD_REQUEST.value())
