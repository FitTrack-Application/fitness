...
// */
// public double calculateProgressPercentage(WeightGoal weightGoal, double
// currentWeight) {
...
// */
// public long estimateDaysToTarget(WeightGoal weightGoal, List<WeightLog>
// weightLogs) {
// if (weightLogs.isEmpty() || weightLogs.size() < 2) {
// // Calculate based on initial plan if not enough data
// LocalDate targetDate =
// convertToLocalDate(weightGoal.getStartingDate()).plusDays(30); // Assume 30
// days
...
// if (daysBetween == 0) {
// LocalDate targetDate =
// convertToLocalDate(weightGoal.getStartingDate()).plusDays(30);
// return ChronoUnit.DAYS.between(LocalDate.now(), targetDate);
// }
...
// else {
// return Math.abs(currentWeight - weightGoal.getGoalWeight()) < 0.5; // Allow
// 0.5kg error margin
// }
// }
