...
class StepGraph extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sortedEntries = List<StepEntry>.from(entries)
      ..sort((a, b) => a.date.compareTo(b.date));
    
    // Find max value for better scaling
    final maxSteps = sortedEntries.map((e) => e.steps).reduce((a, b) => a > b ? a : b);
                    ...
                    child: Padding(
                      ...
                      child: BarChart(
                        BarChartData(
                            ...
                            touchTooltipData: BarTouchTooltipData(
                              ...
                              getTooltipItem: (group, groupIndex, rod, rodIndex) {
                                ...
                                return BarTooltipItem(
                                  '$date\n',
                                  TextStyle(
                                    color: StepGraphTheme.tooltipTextColor(context),
                                    fontWeight: FontWeight.bold,
                                  ),
                                  children: [
                                    TextSpan(
                                      text: '${NumberFormat('#,###').format(entry.steps)} steps',
                                      style: TextStyle(
                                        color: StepGraphTheme.tooltipTextColor(context),
                                        fontWeight: FontWeight.bold,
                                      ),
                          ...
                          barGroups: _createBarGroups(context, sortedEntries, barWidth),
                        ),
                      ),
                    ),
                  ),
