...
class KeycloakService {
  ...
  // static const String issuer = 'http://192.168.1.12:8888/realms/my-fitness';
  ...
  // final String discoveryUrl =
  //     'http://192.168.1.12:8888/realms/my-fitness/.well-known/openid-configuration';
  ...
  Future<void> logout() async {
    ...
    final response = await _dio.post(
      ...
      // 'http://192.168.1.12:8888/realms/my-fitness/protocol/openid-connect/logout',
      options: Options(
        headers: {
